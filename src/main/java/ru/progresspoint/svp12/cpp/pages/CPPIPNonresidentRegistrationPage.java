...
/**
 * Страница Регистрации ВТС - индивидуальный предприниматель, нерезидент РФ
 */
@At("#HOST/clients/draft")
public class CPPIPNonresidentRegistrationPage extends CPPSelectizePageObject {

    //АДРЕС РЕГИСТРАЦИИ
    private static final String clientRegistrationCountryField = "client_ip_persons_attributes_0_reg_address_attributes_country_id";

    @FindBy(id = "client_ip_persons_attributes_0_reg_address_attributes_address")
    ...
    private static final String clientLocationCountryField = "client_ip_persons_attributes_0_location_address_attributes_country_id";

    @FindBy(id = "client_ip_persons_attributes_0_location_address_attributes_address")
    ...
    private static final String clientPostalCountryField = "client_ip_persons_attributes_0_postal_address_attributes_country_id";

    @FindBy(id = "client_ip_persons_attributes_0_postal_address_attributes_address")
