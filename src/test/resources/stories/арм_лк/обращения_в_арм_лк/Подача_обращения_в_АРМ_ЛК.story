...
Сценарий:
В АРМ ЛК Главный менеджер имеет возможность подать обращение
...
Сценарий:
В АРМ ЛК Менеджер ЛС имеет возможность подать обращение
...
Сценарий:
В АРМ ЛК Менеджер группы имеет возможность подать обращение
...
Сценарий:
В АРМ ЛК Главный менеджер может просматривать обращения, созданные Менеджером ЛС и Менеджером группы
...
Сценарий:
В АРМ ЛК Менеджер ЛС может просматривать только свои обращения
...
Сценарий:
В АРМ ЛК Менеджер группы может просматривать только свои обращения
...
Сценарий:
В АРМ ЛК есть возможность запросить историю обращений на электронную почту

Изначально владелец ТС находится на странице Обращения в АРМ ЛК
