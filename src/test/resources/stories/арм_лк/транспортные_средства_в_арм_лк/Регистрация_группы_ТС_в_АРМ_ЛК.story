...
Сценарий: В АРМ ЛК есть возможность регистрировать группы ТС в роли Главный менеджер и Менеджер ЛС
...
Сценарий: При создании группы ТС происходит проверка лимита денежных средств в месяц на отрицательное значение
...
Сценарий: В АРМ ЛК у Менеджера группы ТС есть нет возможности зарегистрировать группы ТС
