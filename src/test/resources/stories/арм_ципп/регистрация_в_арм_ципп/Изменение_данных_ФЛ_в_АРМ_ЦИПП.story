...
Сценарий: При изменении регистрационных данных ФЛ в системе поле ИНН недоступны для изменения
...
Сценарий: При изменении регистрационных данных ФЛ в системе сохранятся новые данные ВТС
