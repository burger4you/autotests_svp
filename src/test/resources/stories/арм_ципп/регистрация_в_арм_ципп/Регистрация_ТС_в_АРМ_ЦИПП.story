...
Сценарий: В АРМ ЦИПП есть возможность регистрировать ТС
...
Сценарий: В АРМ ЦИПП невозможно зарегистрировать ТС с данными, уже существующими в системе ПО СВП

Изначально оператор находится на странице Регистрации ТС в ЦИПП
Если оператор при регистрации введет данные зарегистрированного ТС(Страна регистрации ТС Российская Федерация, ГРЗ T234TT233, Серия и номер СТС 1345324345)
