...
Сценарий: При изменении регистрационных данных ЮЛ в системе поля ОГРН и ИНН недоступны для изменения
...
Сценарий: При изменении регистрационных данных ЮЛ в системе сохранятся новые данные ВТС
