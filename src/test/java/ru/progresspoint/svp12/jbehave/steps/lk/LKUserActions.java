...
//                operator.uploadsFLDocumentsCopies();
    ...
    @When("пользователь введет логин $login и пароль $password для авторизации в АРМ ЛК")
    public void userEntersLoginAndPassword(String login, String password) {
        user.entersLoginAndPassword(login, password);
        user.clicksToConfirmButton();
    }

//    @Composite("пользователь введет логин и пароль для авторизации в АРМ ЛК неверно 5 раз подряд")
